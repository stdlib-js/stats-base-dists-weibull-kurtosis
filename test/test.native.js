...
tape( 'the function returns the excess kurtosis of a Weibull distribution', opts, function test( t ) {
	var expected;
	var lambda;
	var k;
	var i;
	...
	for ( i = 0; i < expected.length; i++ ) {
		...
		t.strictEqual( isAlmostSameValue( y, expected[ i ], 1292760 ), true, 'returns expected value' );
	}
	t.end();
});
